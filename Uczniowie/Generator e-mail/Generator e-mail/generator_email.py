...
for ciag_danych in dane_osob:
    ...
    aktualny_rok = int(tm.localtime()[0])

    if klasa[3:] == 'LO':
        rok_ukoncz = str(aktualny_rok + 3)
        ...
        rok_ukoncz = str(aktualny_rok + 2) # Zamiast 2 trzeba wpisać ilość lat po ilu nowa klasa LOD skończy szkołę
